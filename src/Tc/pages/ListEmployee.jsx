...
function ListEmployee() {
  ...
  const columns = [
    ...
    {
      title: <div className="text-center">Contact</div>,
      dataIndex: "Contact",
      key: "id",
      render: (text) => <div className="text-center">{text}</div>,
    },
    {
      title: <div className="text-center">Gender</div>,
      dataIndex: "Gender",
      key: "id",
      render: (text) => <div className="text-center">{text}</div>,
    },
    {
      title: <div className="text-center">UserType</div>,
      dataIndex: "user_type",
      key: "id",
      render: (text) => (
        <div className="text-center">
          {text == 1 ? "BM" : text == 2 ? "TC" : "MIS"}
        </div>
      ),
    },
    {
      title: <div className="text-center">Branch</div>,

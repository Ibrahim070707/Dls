        ...
        <div style={{ height: "93vh", overflowY: "scroll" }}>
            ...
            <div className="grid mx-5 p-5 rounded-2xl bg-slate-200" style={{ gridTemplateColumns: "30% auto" }}>
                <div className="bg-white overflow-y-scroll mr-2 rounded-xl" style={{ height: "55vh" }}>
                    <p className="text-center f03">Salary Details</p>
                    ...
                    <div className="grid grid-cols-3 gap-5 mb-1">
                        <p className="f01 text-center">{months[month - 3]}</p>
                        <p className="f01 text-center">15000</p>
                        <p className="f01 text-center">13000</p>
                    </div>
                    <div className="grid grid-cols-3 gap-5 mb-1">
                        <p className="f01 text-center">{months[month - 2]}</p>
                        <p className="f01 text-center">15000</p>
                        <p className="f01 text-center">13000</p>
                    </div>
                    <div className="grid grid-cols-3 gap-5 mb-1">
                        <p className="f01 text-center">{months[month - 1]}</p>
                        <p className="f01 text-center">15000</p>
                        <p className="f01 text-center">13000</p>
                    </div>
                    <div className="grid grid-cols-3 gap-5 mb-1">
                        <p className="f01 text-center">{months[month]}</p>
                        <p className="f01 text-center">15000</p>
                        <p className="f01 text-center">13000</p>
                    </div>
                </div>

        ...
        <div>
          <div className="bg-green-200 text-black rounded-2xl p-5 m-5 shadow ">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-sm font-bold">Available Employee(count)</h2>
            </div>
            <div className="grid grid-cols-3">
              ...
              <div className="w-full flex justify-center text-green-700 items-center flex-col text-sm">
                <p className="font-bold">Active Employee</p>
                <p>{CardsData.active ? CardsData.active : 0}</p>
              </div>
              <div className="w-full flex justify-center text-green-700 items-center flex-col text-sm">
                <p className="font-bold">Inactive Employee</p>

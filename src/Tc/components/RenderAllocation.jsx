...
function RenderAllocation() {
    ...
    useEffect(() => {
        ...
        document.getElementById("Allocation").classList.add("activenavLinks");
        return () => {
            document.getElementById("Allocation").classList.remove("activenavLinks");
        ...
        <>
            {loader === true ?
                ...
                <div>
                    ...
                    <div className="bg-green-200 text-black rounded-2xl p-5 m-5 shadow ">
                        ...
                        <div className="grid grid-cols-3">
                            <div className="w-full flex justify-center text-green-700 items-center flex-col text-sm">
                                <p>Total Cases</p>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-7">
                            ...
                            <div className="flex flex-col justify-center w-full">
                                ...
                                <Select
                                    ...
                                    options={MakeData.map((item, index) => ({
                                        value: item.make,
                                        label: item.make
                                    }))}
                                />
                            ...
                            <div className="flex flex-col justify-center w-full">
                                ...
                                <Select
                                    ...
                                    options={ModelData.map((el, index) => ({
                                        label: el.model,
                                        value: el.model
                                    }))}
                                />
                            ...
                            <div className="flex flex-col justify-center w-full">
                                ...
                                <Select
                                    ...
                                    options={LocationData.map((el, index) => ({
                                        label: el.location,
                                        value: el.location
                                    }))}
                                />

...
function RenderAllocation() {
  ...
  const GetEmplyeesData = async () => {
    ...
    await fetch(
      `${Base_Url}Get/Employees/ByBranchID/${UserData.branch_id}`,
      requestOptions
    )
      .then((response) => response.json())
      .then((result) => {
  ...
  const handleChangeBranch = (values) => {
    if (values.includes("all")) {
      EmployeeRef.current = EmployeeswithSelectAll.map(
        (option) => option.value
      );
      setEmp(false);
    } else {
            ...
            if (LocationRef) {
              if (TotalCasesToAllocate) {
                if (EmployeeRef) {
                  ...
                  await fetch(
                    `${Base_Url}Branch/SendAllocation`,
                    requestOptions
                  )
                    .then((response) => response.json())
                    .then((result) => {
          ...
          <div className="bg-blue-200 text-black rounded-2xl p-5 m-5 shadow ">
            <div className="flex items-center ">
              ...
              <h2 className="text-sm font-bold">
                Available Vehicles &amp; Other Details (count)
              </h2>
            </div>

            <div className="grid grid-cols-4 mb-3 ">
              <div className="w-full flex justify-center text-blue-700 items-center flex-col  f01">
                <p className="f01 font-bold text-center mb-2 text-blue-700">
                  Private Car
                </p>
              </div>
              <div className="w-full flex justify-center text-blue-700 items-center flex-col  f01">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-7">
              <div className="flex flex-col justify-center w-full">
                ...
                <Select
                  ...
                  allowClear
                  open={Type}
                  onDropdownVisibleChange={(open) => setType(open)}
              ...
              <div className="flex flex-col justify-center w-full">
                ...
                <Select
                  ...
                  allowClear
                  open={Make}
                  onDropdownVisibleChange={(open) => setMake(open)}
                  style={{
                    width: "100%",
                    overflowY: "scroll",
                  }}
              ...
              <div className="flex flex-col justify-center w-full">
                ...
                <Select
                  ...
                  allowClear
                  open={Model}
                  onDropdownVisibleChange={(open) => setModel(open)}
                  style={{
                    width: "100%",
                  }}
                  maxTagCount={2}
              ...
              <div className="flex flex-col justify-center w-full">
                ...
                <Select
                  ...
                  allowClear
                  open={Year}
                  onDropdownVisibleChange={(open) => setYear(open)}
                  style={{
                    width: "100%",
                  }}
                  maxTagCount={2}
              ...
              <div className="flex flex-col justify-center w-full">
                ...
                <Select
                  ...
                  allowClear
                  open={Location}
                  onDropdownVisibleChange={(open) => setLocation(open)}
                  maxTagCount={2}
                  style={{
                    width: "100%",
                  }}
              ...
              <div className="flex flex-col justify-center w-full">
                ...
                <Select
                  ...
                  allowClear
                  open={Emp}
                  onDropdownVisibleChange={(open) => setEmp(open)}
                  style={{
                    width: "100%",
                  }}
                  maxTagCount={2}

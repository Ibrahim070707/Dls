...
function CreateMovement() {
    ...
    const [FormData, setFormData] = useState({ employee_id: UserData.id });
    ...
    const getDataWithQuote = async () => {
        ...
        await fetch(`${Base_Url}getQuote`, requestOptions)
    ...
    const handleOnSumbit = (e) => {
        ...
        fetch(`${Base_Url}CreateMovment`, requestOptions)
            .then(response => response.json())
            .then(result => {
                if (result.Status === 200) {
                    toast.success("Movement Added Succesfully")
                } else {
                    toast.success("Movement Not Added Succesfully")
                }
                setloader(false)
            })
            .catch(error => console.log('error', error));
    ...
    const handleSelectCheckbox = (event) => {
        setFormData({ ...FormData, ["quote_id"]: event.target.value })
    };
                ...
                <div className="m-5 p-5 rounded-2xl bg-slate-200" style={{ maxHeight: "90vh", overflowY: "scroll" }}>
                    <div className="flex flex-col gap-5">
                        <form onSubmit={handleOnSumbit}>
                            <p className="f03 font-semibold text-gray-500 mb-2">Customer Details:</p>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                                ...
                                <div>
                                    <Label label="Alternate Mobile No" />
                                    <input
                                        style={{ borderRadius: "5px", width: "100%" }}
                                        className="appearance-none block bg-white text-gray-700 border border-gray-200 rounded-xl py-2 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-black f01"
                                        type="number"
                            ...
                            <p className="f03 font-semibold text-gray-500 mb-2 mt-6">Vehicle Details:</p>
                            ...
                            <p className="f03 font-semibold text-gray-500  mt-6">Payment Details:</p>
                            <div className="grid grid-cols-5  gap-5 mb-5">
                                ...
                                <div className="flex justify-center items-center my-3 flex-col mx-5">
                                    ...
                                    <input
                                        ...
                                        className="appearance-none block bg-white text-gray-700 border border-gray-200 rounded-xl py-2 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-black f01"
                                        type="text"
                                        placeholder={FormData.risk_end_date ? FormData.risk_end_date : "Rist Start Date"}
                                    />
                                </div>
                                <div className="flex justify-center items-center my-3 flex-col mx-5">

...
import "../Toggle.css"
function ChangeTheme({ OnChangeTheme }) {
    ...
    return (
        <label class="switch">
            <input class="switch__input" type="checkbox" role="switch" onClick={handleCheckBox} />
            <svg class="switch__scene" viewBox="0 0 48 24" width="48px" height="24px" aria-hidden="true">
